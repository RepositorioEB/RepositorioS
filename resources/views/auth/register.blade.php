...
@section('content')
    ...
    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
        ...
        ?>
                ...
                <input type="hidden" id="contraseña" class="form-control" name="password" value="{{$clave}}">
                <input type="hidden" id="contraseña_confirmar" class="form-control" name="password_confirmation" value="{{$clave}}">
        ...
        <div class="form-group">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    {!! Form::textarea('aviso', 'Se le enviará una contraseña a su correo con la que podrá ingresar al repositorio y cambiarla si lo desea..', ['rows'=>'2','cols'=>'10%','id'=>'aviso','class' => 'form-control','readonly'=>'readonly']) !!}
                </div>
