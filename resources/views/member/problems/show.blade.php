...
@section('content')
	...
	<section>
		<center>
			<a href="{{ route('member.problems.index') }}" title="Problemas" class="btn btn-info"><span class="glyphicon glyphicon-th-list" aria-hidden="true"> Listado de problemas</span></a>
		</center>
	</section>
@endsection