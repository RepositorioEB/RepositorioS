            ...
            <div class="panel-body">                   <!-- Cuerpo del panel-->
            	<div class="media">
			          	<div class="media-center">          <!-- Cuandro de imagen-->
			          		<center><img class="imag-responsive" src="{{asset('images/admin/estiven.png')}}" width="230" height="230" name="photo" alt="braian"/></center>	<!-- Mostrar imagen de creador-->		          	
			        	</div>
			        </div>
            ...
            <div class="panel-body">
            	<div class="media">
			          	<div class="media-center">
			          		<center><img class="imag-responsive" src="{{asset('images/admin/estiven.png')}}" width="230" height="230" name="photo" alt="edison"/></center>	<!-- Mostrar imagen de creador-->		          	
			        	</div>
			        </div>
